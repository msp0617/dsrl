...
# Same method, same colour and marker as the team's GapReach2D figure (grey / blue / red / green);
# IQL does not appear there and gets purple.
COLORS = {"baseline": "#8a8a94", "td": "#4a78b0", "cql": "#e05050", "calql": "#2e8b3a", "iql": "#8b5cf6",
          "fixalpha_03": "#c9368c", "tent12i": "#6d4c41"}
MARKERS = {"baseline": "o", "td": "s", "cql": "^", "calql": "D", "iql": "v", "fixalpha_03": "o", "tent12i": "o"}
